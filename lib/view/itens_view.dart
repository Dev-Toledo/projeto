...
class _ItensViewState extends State<ItensView> {
  ...
  void initState() {
    ...
    itensFuture =
        itemRepository.buscarItens(); // Busca todos os itens do cardápio
  }
              ...
              return Card(
                ...
                child: ListTile(
                  leading: item.imagem.isNotEmpty
                      ? Image.asset(
                          item.imagem) // Exibe a imagem do item, se existir
                      : Icon(
                          Icons.fastfood), // Ícone padrão se não houver imagem
